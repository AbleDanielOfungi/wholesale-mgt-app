...
class SalesManRefineSearch extends StatefulWidget {
  const SalesManRefineSearch({Key? key}) : super(key: key);

  @override
  State<SalesManRefineSearch> createState() => _SalesManRefineSearchState();
}

class _SalesManRefineSearchState extends State<SalesManRefineSearch> {
