...
class SalesManRefineSearchSales extends StatefulWidget {
  const SalesManRefineSearchSales({super.key});

  @override
  State<SalesManRefineSearchSales> createState() =>
      _SalesManRefineSearchSalesState();
}

class _SalesManRefineSearchSalesState extends State<SalesManRefineSearchSales> {
  //dropdown's
