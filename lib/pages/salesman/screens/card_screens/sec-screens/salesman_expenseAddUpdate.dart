...
class SalesManRefineSearchExpense extends StatefulWidget {
  const SalesManRefineSearchExpense({Key? key}) : super(key: key);

  @override
  _SalesManRefineSearchExpenseState createState() =>
      _SalesManRefineSearchExpenseState();
}

class _SalesManRefineSearchExpenseState
    extends State<SalesManRefineSearchExpense> {
