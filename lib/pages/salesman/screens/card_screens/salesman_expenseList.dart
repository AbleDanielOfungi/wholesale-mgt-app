...
import 'package:wholesense/pages/salesman/screens/card_screens/sec-screens/salesman_search_expense_screen.dart';
import 'package:wholesense/pages/salesman/screens/salesman_homeScreen.dart';

class SalesManExpenseList extends StatefulWidget {
  const SalesManExpenseList({Key? key}) : super(key: key);

  @override
  State<SalesManExpenseList> createState() => _SalesManExpenseListState();
}

class _SalesManExpenseListState extends State<SalesManExpenseList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) {
            return const SalesManSearchExpenseScreen();
          }));
        },
