...
class SalesManCustomerDetails extends StatefulWidget {
  static const routeName = '/customerDetail';
  const SalesManCustomerDetails({Key? key}) : super(key: key);

  @override
  State<SalesManCustomerDetails> createState() =>
      _SalesManCustomerDetailsState();
}

class _SalesManCustomerDetailsState extends State<SalesManCustomerDetails> {
