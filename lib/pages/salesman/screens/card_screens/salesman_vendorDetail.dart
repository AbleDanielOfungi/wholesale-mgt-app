...
class SalesManVendorDetail extends StatefulWidget {
  static const routeName = "/vendorDetail";
  const SalesManVendorDetail({Key? key}) : super(key: key);

  @override
  State<SalesManVendorDetail> createState() => _SalesManVendorDetailState();
}

class _SalesManVendorDetailState extends State<SalesManVendorDetail> {
