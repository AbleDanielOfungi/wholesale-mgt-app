...
class SalesManSaleOrder extends StatefulWidget {
  static const routeName = "/saleorder";
  const SalesManSaleOrder({Key? key}) : super(key: key);

  @override
  State<SalesManSaleOrder> createState() => _SalesManSaleOrderState();
}

class _SalesManSaleOrderState extends State<SalesManSaleOrder> {
