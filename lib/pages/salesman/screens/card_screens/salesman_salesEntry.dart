...
//               .update({
//             'quantity': availableQuantity - salesQuantity,
//           });
...
import 'package:wholesense/pages/salesman/screens/card_screens/sec-screens/salesman_customeradd_update.dart';

class SalesManSalesEntry extends StatefulWidget {
  const SalesManSalesEntry({Key? key}) : super(key: key);

  @override
  State<SalesManSalesEntry> createState() => _SalesManSalesEntryState();
}

class _SalesManSalesEntryState extends State<SalesManSalesEntry> {
  final productNameController = TextEditingController();
  final customerNameController = TextEditingController();
  final salesQuantityController = TextEditingController();
  final salesDateController = TextEditingController();
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(context,
                            MaterialPageRoute(builder: (builder) {
                          return const SalesManCustomeAddUpdate();
                        }));
                      },
                      child: const Icon(
                        Icons.add_circle_outline,
