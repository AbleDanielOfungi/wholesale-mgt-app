...
class AdminRefineSearchSales extends StatefulWidget {
  const AdminRefineSearchSales({super.key});

  @override
  State<AdminRefineSearchSales> createState() => _AdminRefineSearchSalesState();
}

class _AdminRefineSearchSalesState extends State<AdminRefineSearchSales> {
  //dropdown's
