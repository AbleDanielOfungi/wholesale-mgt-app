...
class AdminCustomeAddUpdate extends StatefulWidget {
  final String? vendorId;

  const AdminCustomeAddUpdate({Key? key, this.vendorId}) : super(key: key);

  @override
  State<AdminCustomeAddUpdate> createState() => _AdminCustomeAddUpdateState();
}

class _AdminCustomeAddUpdateState extends State<AdminCustomeAddUpdate> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          widget.vendorId != null ? 'Edit Customer' : 'Add Customer',
