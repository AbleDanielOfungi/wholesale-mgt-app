...
class AdminProfitLossScreenn extends StatefulWidget {
  static const routeName = '/profitLoss';

  @override
  _AdminProfitLossScreenState createState() => _AdminProfitLossScreenState();
}

class _AdminProfitLossScreenState extends State<AdminProfitLossScreenn> {
