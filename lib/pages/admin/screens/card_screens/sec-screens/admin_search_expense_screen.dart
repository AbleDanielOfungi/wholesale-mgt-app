...
class AdminSearchExpenseScreen extends StatefulWidget {
  const AdminSearchExpenseScreen({super.key});

  @override
  _AdminSearchExpenseScreenState createState() =>
      _AdminSearchExpenseScreenState();
}

class _AdminSearchExpenseScreenState extends State<AdminSearchExpenseScreen> {
