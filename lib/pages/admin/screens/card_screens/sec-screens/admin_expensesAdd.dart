...
class AdminUploadExpenseScreen extends StatefulWidget {
  const AdminUploadExpenseScreen({Key? key}) : super(key: key);

  @override
  _AdminUploadExpenseScreenState createState() =>
      _AdminUploadExpenseScreenState();
}

class _AdminUploadExpenseScreenState extends State<AdminUploadExpenseScreen> {
